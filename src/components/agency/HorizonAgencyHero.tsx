      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6">
        <div className="max-w-6xl hero-content w-full">
          ...
          <div ref={statsRef} className="mb-6 md:mb-8 flex flex-row justify-center items-center gap-2 sm:gap-4 md:gap-8 text-[10px] sm:text-sm px-2 flex-wrap" style={{ visibility: 'hidden' }}>
            <div className="bg-white/5 border border-white/30 rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 whitespace-nowrap backdrop-blur-md">
              <span className="text-white/80 font-bold">+{counters.automations}</span>
              <span className="text-white ml-1 drop-shadow-lg">{t('hero.stats.automations')}</span>
            </div>
            <div className="bg-white/5 border border-white/30 rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 whitespace-nowrap backdrop-blur-md">
              <span className="text-white/80 font-bold">+{counters.leads}</span>
              <span className="text-white ml-1 drop-shadow-lg">{t('hero.stats.leads')}</span>
            </div>
            <div className="bg-white/5 border border-white/30 rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 whitespace-nowrap backdrop-blur-md">
              <span className="text-white/80 font-bold">+{counters.hours}</span>
          ...
          <h1 ref={titleRef} className="hero-title font-space-grotesk mb-4 md:mb-6 relative" style={{ visibility: 'hidden' }}>
            ...
            <span className="relative block text-3xl sm:text-5xl md:text-8xl font-bold mb-2 md:mb-4 drop-shadow-2xl text-white" style={{ fontFamily: content.title === 'FLUXROW' ? 'Akony, sans-serif' : undefined, textShadow: '0 0 30px rgba(6, 182, 212, 0.8), 0 0 60px rgba(139, 92, 246, 0.5)' }}>{content.title}</span>
          </h1>
          ...
          <div ref={ctaRef} className="hero-cta flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-8 md:mb-12 px-2" style={{ visibility: 'hidden' }}>
            ...
            <button 
              ...
              className="bg-transparent border-2 border-white/10 text-white/80 px-6 sm:px-10 py-4 sm:py-5 rounded-full font-semibold font-space-grotesk hover:bg-white/10 transition-all duration-300 group flex items-center justify-center backdrop-blur-sm w-full sm:w-auto"
            >
            ...
            <a
              ...
              className="bg-white hover:bg-white/90 text-white px-6 sm:px-10 py-4 sm:py-5 rounded-full font-semibold font-space-grotesk transition-all duration-300 group flex items-center justify-center w-full sm:w-auto shadow-lg shadow-black/20 hover:scale-105"
            >
