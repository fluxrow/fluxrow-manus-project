...
/**
 * ProceduralGround
 * WebGL background with topographic neon lines and sand-ripple movement.
 * Adapted to Fluxrow color palette (cyan, purple, pink).
 */
const ProceduralGround: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Fluxrow Color Palette
        vec3 baseColor = vec3(0.04, 0.02, 0.08);    // Deep dark purple-black
        vec3 accentColor = vec3(0.0, 0.85, 0.85);   // Cyan-400
        vec3 neonColor = vec3(0.65, 0.3, 0.95);     // Purple-500
        ...
        finalColor += topoLine * vec3(0.9, 0.4, 0.6) * depth * 0.15;
