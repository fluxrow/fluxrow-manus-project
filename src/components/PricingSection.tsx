        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="pricing-card max-w-lg" data-aos="fade-left">
            ...
            <div className="pricing-features text-left mb-8">
              <div className="feature py-3 border-b border-gray-700 text-white font-space-grotesk flex items-start gap-3 safe-wrap">
              ...
              <div className="feature py-3 text-white font-space-grotesk flex items-start gap-3 safe-wrap">
