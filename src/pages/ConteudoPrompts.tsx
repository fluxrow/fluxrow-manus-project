          ...
          <div className="bg-white/[0.03] border border-white/15 rounded-sm p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-black/20 p-6 rounded-lg">
                ...
                <ul className="space-y-break-words 2 text-gray-300 font-space-grotesk text-sm">
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8 max-w-4xl mx-auto">
                <div className="bg-black/20 p-6 rounded-lg">
                  ...
                  <ul className="text-left space-y-break-words 2 text-gray-300 font-space-grotesk">
