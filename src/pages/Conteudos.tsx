        ...
        <section className="max-w-5xl mx-auto px-6 mt-24 pt-16 border-t border-white/5">
          <div className="grid md:grid-cols-[2fr_1fr] gap-10 items-end">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white text-[#080807] font-medium rounded-sm hover:bg-white/90 transition-colors text-sm md:justify-self-end"
            >
