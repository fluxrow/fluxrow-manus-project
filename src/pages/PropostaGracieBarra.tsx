    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src={heroImage}
            alt="Aula de Brazilian Jiu-Jitsu na Gracie Barra North Charleston"
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-transparent via-red-950/10 to-transparent relative">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              A realidade de <span className="text-red-500">North Charleston</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center">
            <Button
              ...
              onClick={() =>
                window.open(
                  'https://wa.me/5541992361868?text=Olá! Vi a proposta da Gracie Barra North Charleston e gostaria de conversar.',
                  '_blank'
                )
              }
