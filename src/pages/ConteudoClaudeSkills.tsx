        ...
        <article className="max-w-4xl mx-auto">
          ...
          <nav aria-label="Sumário" className="glass-card mb-10 border border-cyan-500/20">
            ...
            <ol className="space-y-1.5 text-gray-300 font-space-grotesk text-sm list-decimal list-inside">
              <li><a href="#conceito" className="hover:text-cyan-300">O conceito de Skill</a></li>
              <li><a href="#anatomia" className="hover:text-cyan-300">Anatomia de uma Skill</a></li>
              <li><a href="#frontmatter" className="hover:text-cyan-300">Frontmatter: name e description</a></li>
              <li><a href="#vs" className="hover:text-cyan-300">Skills vs Prompts vs MCP</a></li>
              <li><a href="#exemplos" className="hover:text-cyan-300">Exemplos prontos de Skills</a></li>
              <li><a href="#criar" className="hover:text-cyan-300">Sua primeira Skill em 4 passos</a></li>
              <li><a href="#boas-praticas" className="hover:text-cyan-300">Boas práticas de design</a></li>
          ...
          <section id="conceito" className="glass-card mb-8 scroll-mt-24">
            ...
            <p className="text-gray-300 font-space-grotesk leading-relaxed mb-3">
              Claude Skill é um diretório com um arquivo <code className="text-cyan-300">SKILL.md</code> (instruções +
...
└── exemplos/
    └── relatorio-2025-W42.pdf`}
            ...
            <p className="text-gray-300 font-space-grotesk text-sm">
              Quando ativada, o Claude lê o <code className="text-cyan-300">SKILL.md</code>, decide quais arquivos
...
3. ...`}
          ...
          <section id="boas-praticas" className="glass-card mb-8 scroll-mt-24">
            ...
            <ul className="space-y-2 text-gray-300 font-space-grotesk">
              ...
              <li>• Combine com <Link to="/conteudos/mcp-claude" className="text-cyan-300 underline">MCP</Link> para dados vivos e com <Link to="/conteudos/claude-code" className="text-cyan-300 underline">Claude Code</Link> para execução autônoma.</li>
            </ul>
          </section>
