...
const PropostaPromotrip = () => {
  ...
  return (
    <div id="proposal-content" className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 text-white">
      <BackToHomeButton />
      <DownloadPdfButton contentId="proposal-content" filename="Proposta-Promotrip.pdf" />
      {/* Animated Background */}
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                  R$ 1.500<span className="text-2xl text-gray-400">/mês</span>
                </p>
